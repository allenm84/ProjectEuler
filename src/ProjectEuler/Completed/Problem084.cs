...
namespace ProjectEuler
{
  public class Problem084 : EulerProblem
  {
    ...
    static readonly MonopolySquare[] Railways;
    static readonly MonopolySquare[] Utilities;

    static readonly Dictionary<MonopolySquare, Func<MonopolySquare, MonopolySquare>> SquareFunctions = new Dictionary<MonopolySquare, Func<MonopolySquare, MonopolySquare>>();
    static readonly MonopolySquare[] Squares = Enum.GetValues(typeof(MonopolySquare)).Cast<MonopolySquare>().ToArray();
    ...
    static MonopolySquare ApplyMovement(MonopolySquare square, int amount)
    {
      var value = (((int)square) + amount) % Squares.Length;
      return (MonopolySquare)value;
    }

    static MonopolySquare SameSquare(MonopolySquare square)
    {
      return square;
    }

    static MonopolySquare CommunityChest(MonopolySquare square)
    {
      int card = random.Next(16) + 1;
      if (card == 1) return MonopolySquare.GO;
      if (card == 2) return MonopolySquare.JAIL;
      return square;
    }

    static MonopolySquare Chance(MonopolySquare square)
    {
      MonopolySquare retval = square;
      int card = random.Next(16) + 1;

      switch (card)
      {
        case 1: { retval = MonopolySquare.GO; break; }
        case 2: { retval = MonopolySquare.JAIL; break; }
        case 3: { retval = MonopolySquare.C1; break; }
        case 4: { retval = MonopolySquare.E3; break; }
        case 5: { retval = MonopolySquare.H2; break; }
        case 6: { retval = MonopolySquare.R1; break; }
        case 7: { retval = Next(square, Railways); break; }
        case 8: { retval = Next(square, Railways); break; }
        case 9: { retval = Next(square, Utilities); break; }
        case 10: { retval = ApplyMovement(square, -3); break; }
      }

      return retval;
    }

    static MonopolySquare Next(MonopolySquare square, params MonopolySquare[] choices)
    {
    ...
    public override int Number { get { return 84; } }
    ...
    protected Dictionary<MonopolySquare, int> PlayMonopolyGame(int rolls, int numSides)
    {
      ...
      for (int r = 0; r < rolls; ++r)
      {
        ...
        int dice1 = random.Next(numSides) + 1;
        int dice2 = random.Next(numSides) + 1;
